        ...
        <section className={styles.menu}>
            ...
            <div className={styles.menu__details}>
                <div className={styles.menu__details__contact}>
                    ...
                    <div><span className={styles.menu__details__contact__icon}><BsPhone /></span><p>+44 123 654 7890</p></div>
                </div>
            ...
            <div className={styles.menu__options}>
                ...
                <a href="#contact"><h2 onClick={() => { props.toggle(!props.state) }}>Contact</h2></a>    
            </div>     
        </section>
    )
}
