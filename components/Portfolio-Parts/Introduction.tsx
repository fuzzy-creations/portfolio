...
function Introduction(){
    return (
        <section className={styles.intro} id="expertise">
            <Column gap={1}>
                <h5>- Introduction</h5>
                <p>A creative, dedicated software developer, thinker and innovator working from London. Specialised in ReactJS and React Native with a particular interest in technology products that utilise effective, simple and reusable code, I seek innovative approaches to development challenges.</p>
            </Column>
